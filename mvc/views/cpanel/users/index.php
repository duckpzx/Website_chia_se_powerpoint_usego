<?php
    ...
    // If on exists firstLogin user then remove Session 
    ...
    if(!empty($dataSql['totalUsers'])) :
    $totalUsers = $dataSql['totalUsers'];
    endif; // Data Top Author

    if(!empty($dataSql['dataPowerpoint'])) :
    $dataPowerpoint = $dataSql['dataPowerpoint'];
    endif; // Data File Powerpoint 

    if(!empty($dataSql['dataTopPowerpoint'])) :
    $dataTopPowerpoint = $dataSql['dataTopPowerpoint'];
    endif; // Data Top File Powerpoint 

    $firstThreeItems = array_slice($dataPowerpoint, 0, 4);
    $dataPowerpoint = array_slice($dataPowerpoint, 3, 8);

    if(!empty($dataSql['dataTopAuthor'])) :
    $dataTopAuthor = $dataSql['dataTopAuthor'];
    endif; // Data Top Author
    ...
    <div class="container">
        ...
        <div class="path-list-title">
            <ul id="lists-title" class="title-texts">
                <li>
                    <a href="#" class="title-style title-bold">Cập nhật</a>
                </li>
                <li>
                    <a href="#" class="title-bold">Phổ biến</a>
                </li>
                <li>
                    <a href="/usego/trademark">
        ...
        <div class="archive-lists flex flex-juscenter">
            ...
            <section>
                ...
                <div class="content">
                        ...
                        <div class="widget-wrap">
                            ...
                            <div class="widget-title">
                                <a href="#" class="title-corner">
                                    ...
                                    <small><?= 'thứ ' . date('l') . ' năm ' . date('Y') . ' tháng ' . date('m') ?></small>
                                </a>
                    ...
                    <?php } else { ?>
                        <p class="title"> <?= $item['title'] ?? _no_data ?> </p>
        ...
        <div class="home-list-btns part-tags">
            <div class="left-title flex">
            <h2 class="flex flex-alicenter">Chuyên mục nổi bật <span class="hot_title">nóng</span></h2>
        ...
        <div class="home-list-btns part-tags">
            <div class="left-title flex">
            <h2 class="flex flex-alicenter">Nội dung chính <span class="hot_title">nóng</span></h2>
        ...
        <div class="home-list-btns part-tags pt-small">
            <div class="left-title flex">
            <h2 class="flex flex-alicenter">Tác giả nổi bật<span class="hot_title">nóng</span></h2>
