        ...
        ${
          ...
          <span class="alert-close ${
            closeStyle === 'circle'
              ? 'alert-close-circle'
              : 'alert-close-default'
          }"><i class="fa-solid fa-xmark"></i></span></span>
          ${
            img === undefined
      ...
      <div>
        <div class="toast-frame">
          <div class="toast-body">
            <img class="toast-body-img" src="${src}/img/${type}.png" />
            <div class="toast-body-content">
              <span class="toast-title ${type}">${title}</span>
              <span class="toast-message ${type}">${message}</span>
            </div>
            <div class="toast-close" id="${toastId}-toast-close"><i class="fa-solid fa-xmark"></i></span></div>
          </div>
        </div>
